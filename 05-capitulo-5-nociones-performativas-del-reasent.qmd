...
Los resultados del presente estudio se categorizaron en diez componentes psicosociales del reasentamiento social. La @tbl-c5-01 sintetiza los componentes encontrados en la revisión documental según país, por su parte la @fig-c5-01 condensa la relación encontrada entre los componentes psicosociales.
...
: Componentes psicosociales investigados por país. Fuente: propia. {#tbl-c5-01}
...
### 5.4.1 Componente institucional
...
### 5.4.2 Componente participación y organización social
...
- Procesos de consulta con líderes naturales y electos. - Diseño de comités entre instituciones y comunidades para tomar decisiones. 
...
### 5.4.3 Componente Jurídico-Político
...
- Presupuesto en función de un proyecto que articule el desarrollo arquitectónico y social. Asesorías legales personalizadas.
...
- Conocimiento de los riesgos residuales en los territorios receptores, entendidos como aquellos posibles daños y pérdidas que, aun tomando medidas para su intervención, su impacto no llega a un punto cero [[60]](#ref-60). 
...
- Programas específicos de promoción de empleo, formación y fondos de apoyo a emprendimiento. Análisis de características contextuales que permitan determinadas actividades económicas en el territorio de origen y receptor, así como los posibles cambios en actividades productivas. 
...
- Diagnóstico del poder adquisitivo de las familias reasentadas y receptoras de bienes muebles e inmuebles. - Propuestas claras de acciones que permitan la distribución de recursos y remuneración de factores de producción, respetando saberes locales y la coexistencia de la naturaleza en el territorio.
:::

### 5.4.6 Componente prácticas socioculturales
...
### 5.4.8 Componente percepción social del riesgo
...
### 5.4.9 Componente estrategias sociales de afrontamiento
...
### 5.4.10 Componente salud mental y física
...
- Reconocimiento de la soberanía alimentaria Plan de promoción de hábitos de vida saludables en el territorio receptor.
...
- El reasentamiento social deviene en una oportunidad para la construcción de comunidades y territorios situados en el conocimiento y la dignidad para la reducción del riesgo de desastres.
:::
## 5.6 METODOLOGÍA
